/// The single stylesheet for all markdown-rendering WebViews (Reader/Transform
/// preview and the checkable Notes preview), so the same document never looks
/// different from one tab to another.
enum MarkdownPreviewStyle {
    static let css = """
        :root {
        ...
        li.task input[type="checkbox"] { accent-color: var(--accent); vertical-align: -2px;
